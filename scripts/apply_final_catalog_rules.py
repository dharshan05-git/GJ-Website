...
FINAL_MAPPINGS = {
    ...
    # ==================== 2. EARRINGS (10) ====================
    # Strictly Plain Studio Solo Shot as Cover, Model as 2nd
    ...
    ("EARRINGS", "Pink Flower Drop"): [
        "ChatGPT Image Aug 5, 2026, 12_06_56 AM.png", # 1. PLAIN STUDIO COVER (Fixed)
    ...
    ("EARRINGS", "Red Stone Stud"): [
        "ChatGPT Image Aug 5, 2026, 01_34_48 AM.png", # 1. PLAIN STUDIO COVER (Fixed)
    ...
    ("EARRINGS", "Topaz Ear Crawler"): [
        "Gemini_Generated_Image_ffnwrqffnwrqffnw.png",# 1. PLAIN STUDIO COVER (Fixed)
    ...
    ("studs", "Emerald Cut Studs"): [
        "gemini-watermark-removed (6).png",               # 1. 2nd image as cover (User requested)
        "a7bb15cf-0023-47ae-ad88-19796d16f94c-clean.png", # 2. plain studio
        "gemini-watermark-removed (7).png",               # 3. angle
        "WhatsApp Image 2026-09-14 at 7.45.15 PM.jpeg"    # 4. box
    ],
    ("studs", "Gold Leopard Studs"): [
        "746ee96b-7763-4e6a-91cf-c23e1eb061f5-clean.png", # 1. 3rd image as cover (User requested)
        "3af62380-220b-4ee8-9513-f788a8bd070c-clean.png", # 2. plain studio
        "4ebab4a2-7052-49b6-bcdf-63a3e411acb4-clean.png", # 3. model ear
        "gemini-watermark-removed (5).png"                # 4. box
    ],
    ("studs", "Round Diamond Studs"): [
        "ba9b331d-8f26-46f0-9688-5c7bcdc53ba4-clean.png", # 1. 2nd image as cover (User requested)
        "84115cf1-3545-4ac0-90ac-ff23af36a860-clean.png", # 2. plain studio
    ...
    ("pendant", "Gold Swirl Pendant"): [
        "ChatGPT Image Sep 13, 2026, 10_41_38 AM.png",   # 1. 3rd image as cover (User requested)
    ...
    ("pendant", "Gold Teardrop Pendant"): [
        "ChatGPT Image Sep 13, 2026, 11_53_46 AM.png",   # 1. 3rd image as cover (User requested)
    ...
    ("pendant", "Gold Wing Pendant"): [
        "WhatsApp Image 2026-09-11 at 11.29.49 PM.jpeg", # 1. 3rd image as cover (User requested)
    ...
    ("pendant", "Green Leaf Pendant"): [
        "WhatsApp Image 2026-09-11 at 11.22.49 PM.jpeg", # 1. 3rd image as cover (User requested)
    ...
    ("Men's braclet", "Gold Clover Bracelet"): [
        "ChatGPT Image Sep 14, 2026, 02_14_51 AM.png",                 # 1. 3rd uploaded image as Cover (User requested)
    ...
    ("Men's braclet", "Ruby Emerald Bracelet"): [
        "WhatsApp Image 2026-09-14 at 9.58.01 PM.jpeg",                # 1. 3rd uploaded image as Cover (User requested)
...
for idx, p in enumerate(pdf_prods):
    ...
    source_files = FINAL_MAPPINGS.get((folder_cat, folder_prod_name))
    if not source_files:
