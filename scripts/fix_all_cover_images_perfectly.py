...
PERFECT_MAPPINGS = {
    # ==================== 1. PENDANTS (10) ====================
    # Slot 1: Clean styled/solo pendant (NO BOX!)
    # Slot 2: Model wearing on neck
    # Slot 3: Angle/Detail
    # Slot 4: Box shot
    ("pendant", "Gold Knot Pendant"): [
        "WhatsApp Image 2026-09-11 at 11.32.02 PM.jpeg", # 1. Clean solo cover (NO BOX)
        "ChatGPT Image Sep 12, 2026, 11_18_13 PM.png",   # 2. Model neck
        "WhatsApp Image 2026-09-14 at 10.12.43 PM.jpeg", # 3. Angle
        "WhatsApp Image 2026-09-12 at 10.00.17 PM.jpeg"  # 4. Box shot
    ],
    ("pendant", "Gold Swirl Pendant"): [
        "WhatsApp Image 2026-09-11 at 10.38.16 PM.jpeg", # 1. Clean solo cover (NO BOX)
        "ChatGPT Image Sep 12, 2026, 11_02_01 PM.png",   # 2. Model neck
        "ChatGPT Image Sep 13, 2026, 10_41_38 AM.png",   # 3. Angle
        "ChatGPT Image Sep 12, 2026, 10_33_55 PM.png"   # 4. Box shot
    ],
    ("pendant", "Gold Teardrop Pendant"): [
        "WhatsApp Image 2026-09-11 at 11.21.09 PM.jpeg", # 1. Clean solo cover (NO BOX)
        "ChatGPT Image Sep 12, 2026, 11_09_15 PM.png",   # 2. Model neck
        "ChatGPT Image Sep 13, 2026, 11_53_46 AM.png",   # 3. Angle
        "ChatGPT Image Sep 12, 2026, 10_30_19 PM.png"   # 4. Box shot
    ],
    ("pendant", "Gold Wing Pendant"): [
        "WhatsApp Image 2026-09-11 at 11.29.49 PM.jpeg", # 1. Clean solo cover (NO BOX)
        "ChatGPT Image Sep 12, 2026, 11_16_10 PM.png",   # 2. Model neck
        "WhatsApp Image 2026-09-11 at 11.29.49 PM.jpeg", # 3. Angle
        "ChatGPT Image Sep 12, 2026, 10_11_42 PM.png"   # 4. Box shot
    ],
    ("pendant", "Green Leaf Pendant"): [
        "WhatsApp Image 2026-09-11 at 11.22.49 PM.jpeg", # 1. Clean solo cover (NO BOX)
        "ChatGPT Image Sep 12, 2026, 11_12_09 PM.png",   # 2. Model neck
        "WhatsApp Image 2026-09-11 at 11.22.49 PM.jpeg", # 3. Angle
        "ChatGPT Image Sep 12, 2026, 10_29_36 PM.png"   # 4. Box shot
    ],
    ("pendant", "Pink Butterfly Pendant"): [
        "WhatsApp Image 2026-09-11 at 11.33.38 PM.jpeg", # 1. Clean solo cover (NO BOX)
        "ChatGPT Image Sep 12, 2026, 11_25_11 PM.png",   # 2. Model neck
        "WhatsApp Image 2026-09-14 at 4.00.48 PM.jpeg",   # 3. Angle
        "WhatsApp Image 2026-09-12 at 9.56.48 PM.jpeg"   # 4. Box shot
    ],
    ("pendant", "Pink Flower Pendant"): [
        "WhatsApp Image 2026-09-11 at 11.02.48 PM.jpeg", # 1. Clean solo cover (NO BOX)
        "ChatGPT Image Sep 12, 2026, 11_04_38 PM.png",   # 2. Model neck
        "ChatGPT Image Sep 13, 2026, 10_50_45 AM.png",   # 3. Angle
        "WhatsApp Image 2026-09-12 at 12.28.13 AM.jpeg"  # 4. Box shot
    ],
    ("pendant", "Pink Leaf Pendant"): [
        "ChatGPT Image Sep 9, 2026, 08_24_15 AM.png",    # 1. Clean solo cover (NO BOX)
        "ChatGPT Image Sep 12, 2026, 11_07_12 PM.png",   # 2. Model neck
        "ChatGPT Image Sep 13, 2026, 11_50_16 AM.png",   # 3. Angle
        "WhatsApp Image 2026-09-12 at 9.55.46 PM.jpeg"   # 4. Box shot
    ],
    ("pendant", "White Flower Pendant"): [
        "WhatsApp Image 2026-09-11 at 11.41.35 PM.jpeg", # 1. Clean solo cover (NO BOX)
        "ChatGPT Image Sep 12, 2026, 11_27_48 PM.png",   # 2. Model neck
        "WhatsApp Image 2026-09-14 at 3.50.55 PM.jpeg",  # 3. Angle
        "WhatsApp Image 2026-09-12 at 9.58.15 PM.jpeg"   # 4. Box shot
    ],
    ("pendant", "White Star Pendant"): [
        "WhatsApp Image 2026-09-14 at 02.31.51.jpeg",    # 1. Clean solo cover (NO BOX)
        "WhatsApp Image 2026-09-14 at 02.32.23.jpeg",    # 2. Model neck
        "WhatsApp Image 2026-09-14 at 02.42.13.jpeg",    # 3. Angle
        "WhatsApp Image 2026-09-14 at 3.26.23 PM.jpeg"   # 4. Box shot
    ],

    # ==================== 2. STUDS (4) ====================
    # Slot 1: Clean studio stud shot (NO BOX!)
    # Slot 2: Model wearing on ear
    # Slot 3: Angle
    # Slot 4: Box shot
    ("studs", "Cushion Halo Studs"): [
        "c2cb8320-7d68-4bbd-8ed6-d5fac15410e1-clean.png", # 1. Clean solo cover (NO BOX)
        "gemini-watermark-removed (3).png",               # 2. Model ear
        "gemini-watermark-removed (4).png",               # 3. Angle
        "e395ccf1-a70a-4b7b-a513-baba202ec7bf-clean.png" # 4. Box shot
    ],
    ("studs", "Emerald Cut Studs"): [
        "gemini-watermark-removed (7).png",               # 1. Clean solo cover (NO BOX)
        "gemini-watermark-removed (6).png",               # 2. Model ear
        "WhatsApp Image 2026-09-14 at 7.45.15 PM.jpeg",   # 3. Angle
        "a7bb15cf-0023-47ae-ad88-19796d16f94c-clean.png" # 4. Box shot
    ],
    ("studs", "Gold Leopard Studs"): [
        "4ebab4a2-7052-49b6-bcdf-63a3e411acb4-clean.png", # 1. Clean solo cover (NO BOX)
        "746ee96b-7763-4e6a-91cf-c23e1eb061f5-clean.png", # 2. Model ear
        "gemini-watermark-removed (5).png",               # 3. Angle
        "3af62380-220b-4ee8-9513-f788a8bd070c-clean.png" # 4. Box shot
    ],
    ("studs", "Round Diamond Studs"): [
        "ba9b331d-8f26-46f0-9688-5c7bcdc53ba4-clean.png", # 1. Clean solo cover (NO BOX)
        "gemini-watermark-removed (2).png",               # 2. Model ear
        "gemini-watermark-removed (1).png",               # 3. Angle
        "84115cf1-3545-4ac0-90ac-ff23af36a860-clean.png" # 4. Box shot
    ],

    # ==================== 3. MEN'S BRACELETS (4) ====================
    # Slot 1: Clean solo bracelet (NO BOX!)
    # Slot 2: Model wrist
    # Slot 3: Angle
    # Slot 4: Box shot
    ("Men's braclet", "Diamond Tennis Bracelet"): [
        "gemini-watermark-removed.png",                                # 1. Cover (was 3rd image as requested)
        "ChatGPT Image Aug 14, 2026, 12_49_01 AM.png",                # 2. Model wrist
        "watermark-removed-8adf7324-f745-4ae0-8f42-4d24b020bb00.jpg", # 3. Angle
        "WhatsApp Image 2026-09-14 at 8.15.46 PM.jpeg"                # 4. Box shot
    ],
    ("Men's braclet", "Gold Clover Bracelet"): [
        "ChatGPT Image Sep 14, 2026, 02_00_26 AM.png", # 1. Clean solo cover
        "ChatGPT Image Sep 14, 2026, 01_55_01 AM.png", # 2. Model wrist
        "ChatGPT Image Sep 14, 2026, 02_14_51 AM.png", # 3. Angle
        "d4f84afe-c58e-4152-b747-2067c3f5c0e4-clean.png" # 4. Box shot
    ],
    ("Men's braclet", "Gold Cuff Bangle"): [
        "watermark-removed-1f2c658a-3732-4135-9953-240e5d69c759.jpg", # 1. Cover (was 2nd image as requested)
        "watermark-removed-f6599f44-4162-4879-957e-11df46576288.jpg", # 2. Solo bangle
        "watermark-removed-6da0db17-4138-4958-9a72-9200d96eae7c.jpg", # 3. Angle
        "watermark-removed-1d4cf21e-0fd1-44dc-a956-611e23fd8d75.jpg" # 4. Box shot
    ],
    ("Men's braclet", "Ruby Emerald Bracelet"): [
        "WhatsApp Image 2026-09-14 at 9.58.01 PM.jpeg",   # 1. Cover (was 2nd image as requested)
        "b1bfc991-81cf-42f7-bdb8-df240d831284-clean.png", # 2. Clean solo
        "WhatsApp Image 2026-09-14 at 9.59.50 PM.jpeg",   # 3. Angle
        "1cf5f706-750c-42ad-81a8-fa6449dc96f3-clean.png" # 4. Box shot
    ],
    ...
    ("Sets", "Gold Heart Set"): [
        "WhatsApp Image 2026-09-14 at 10.09.34 PM (2).jpeg", # 1. COVER (was 4th image as requested)
        "watermark-removed-1000051950.png", # 2. Model image
    ...
    ("Sets", "Rose Flower Set"): [
        "WhatsApp Image 2026-09-14 at 10.09.35 PM (2).jpeg", # 1. COVER (was 4th image as requested)
        "WhatsApp Image 2026-09-14 at 10.09.34 PM.jpeg", # 2. Model image
    ...
    ("EARRINGS", "Diamond Heart Stud"): [
        ...
        "Gemini_Generated_Image_66afvw66afvw66af.jpeg"  # 4. box
    ],
    ...
    ("EARRINGS", "Pink Flower Drop"): [
        "ChatGPT Image Aug 5, 2026, 12_06_56 AM.png", # 1. PLAIN STUDIO COVER
    ...
    ("EARRINGS", "Red Stone Stud"): [
        "ChatGPT Image Aug 5, 2026, 01_34_48 AM.png", # 1. PLAIN STUDIO COVER
    ...
    ("EARRINGS", "Topaz Ear Crawler"): [
        "Gemini_Generated_Image_ffnwrqffnwrqffnw.png",# 1. PLAIN STUDIO COVER
...
for idx, p in enumerate(pdf_prods):
    ...
    source_files = PERFECT_MAPPINGS.get((folder_cat, folder_prod_name))
    if not source_files:
