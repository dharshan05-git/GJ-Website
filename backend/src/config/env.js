...
export const env = {
  ...
  mail: {
    ...
    from: process.env.MAIL_FROM || 'GEVARIYA JEWELS <onboarding@resend.dev>',
    adminAlert: process.env.ADMIN_ALERT_EMAIL || 'gevariyajewels@gmail.com',
    /** True if Resend API Key or SMTP credentials are configured. */
    get configured() {
      return Boolean(this.resendApiKey || (this.host && this.user && this.pass));
    },
  },
