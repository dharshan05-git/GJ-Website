...
const StorefrontLayout = ({ children }) => {
  const { toastMessage, maintenance, trackOrderOpen, setTrackOrderOpen } = useShop();
  ...
  return (
    <div className="min-h-screen flex flex-col bg-white selection:bg-[#A67B8A] selection:text-white relative overflow-x-hidden">
      ...
      {toastMessage && (
        <div className="fixed bottom-20 right-4 left-4 sm:left-auto sm:right-6 sm:bottom-6 z-[2000] bg-[#1A1615] text-white text-xs font-semibold px-4 py-3 sm:px-5 sm:py-3.5 shadow-2xl border border-[#A67B8A]/40 flex items-center justify-center sm:justify-start gap-2 rounded-lg">
